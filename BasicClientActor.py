...
class BasicClientActor(BasicClientActorAbs):
    ...
    def handle_get_action(self, state):
        ...
        action_probs = self.mcts.getActionProb(state, search=True)
        
        next_move = self.game.one_hot_to_action(np.argmax(action_probs))
    ...
    def handle_game_start(self, start_player):
        ...
        self.game = StateManager(start_player)
        self.mcts = MCTS(self.game, self.model, eps=0.1, c_ucb=1, search_time=3.2)
